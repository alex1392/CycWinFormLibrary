namespace MetroFramework.Controls
{
	partial class ImageViewer
	{
		...
		private void InitializeComponent()
		{
			...
			this.ScrollBarHorizontal = new MetroFramework.Controls.ScrollBar();
			this.ScrollBarVertical = new MetroFramework.Controls.ScrollBar();
			...
			this.ScrollBarHorizontal.Orientation = MetroFramework.ScrollBarOrientation.Horizontal;
			...
			this.ScrollBarVertical.Orientation = MetroFramework.ScrollBarOrientation.Vertical;
