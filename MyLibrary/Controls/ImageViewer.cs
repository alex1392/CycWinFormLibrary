...
namespace MyLibrary.Controls
{
  ...
  public partial class ImageViewer : UserControl
  {
    ...
    {
      Image DisplayImage = new Bitmap(pictureBox.Width, pictureBox.Height); //使用new，已經不是原來的DisplayImage
      if (OriginImage == null)
      {
        return DisplayImage;
      }
      ...
      Rectangle BoundaryRectangle = new Rectangle
      {
        X = 0,
        Y = 0,
        Width = (int)(OriginImage.Width * ZoomFactor),
        Height = (int)(OriginImage.Height * ZoomFactor),
      };
    ...
    private void BackgroundWorker_DoWork(object sender, DoWorkEventArgs DoWork_e)
    {
      ...
      Image DisplayImage = (Image)args.parameters[1]; //讓擴充功能不會共搶欄位
      Point ImageBoxPos = (Point)args.parameters[2];
      ...
      object[] results = { DisplayImage, ImageBoxPos };
      DoWork_e.Result = results; //輸出更改的值
    }
    ...
    private void BackgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
    {
      ...
      DisplayImage = (Image)results[0];
      ImageBoxPos = (Point)results[1];
      UpdateScrollBar();
      UpdatePictureBox();
    ...
    protected override void OnMouseWheel(MouseEventArgs e)
    {
      ...
      object[] parameters = { OriginImage, DisplayImage, ImageBoxPos };
