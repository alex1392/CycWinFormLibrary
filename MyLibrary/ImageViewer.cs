		...
		public Point ImageBoxPos
		{
			...
			private set
			{
				...
				_ImageBoxPos.X = IsImageWidthExceed ?
					CustomMethods.Clamp(value.X, OriginImage.Width - EffectivePictureBoxWidth, 0) : 0;
				_ImageBoxPos.Y = IsImageHeightExceed ?
					CustomMethods.Clamp(value.Y, OriginImage.Height - EffectivePictureBoxHeight, 0) : 0;
			}
		}
